/**
 * Audio Download and Upload Script
 *
 * This script:
 * 1. Fetches naats from the database that don't have audioId
 * 2. Downloads audio using yt-dlp from local machine
 * 3. Uploads to Appwrite Storage
 * 4. Updates database with audioId
 *
 * Usage:
 *   node scripts/download-audio.js [--limit=10] [--test]
 *
 * Options:
 ...
 */
async function main() {
  console.log("🎵 Audio Download and Upload Script\n");
